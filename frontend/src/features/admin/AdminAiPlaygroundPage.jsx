...
const starterPrompt = 'Create three character names and a one-sentence backstory for each. Make them feel distinct and rooted in a strange coastal kingdom.';
...
export default function AdminAiPlaygroundPage() {
  ...
  return (
    <section>
      ...
      <p className="muted">Test the server-side GPT-5.6 Luna connection before generation tools appear in character creation.</p>
