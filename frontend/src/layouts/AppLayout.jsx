				...
				<nav className={styles.nav} ref={menuRef}>
					<div className={styles.menu}>
						<button
							...
							onClick={() => toggleMenu("adventures")}
						>
							Adventures
						</button>
						{openMenu === "adventures" && (
							<div className={styles.menuPanel}>
								<Link to="/adventures" onClick={closeMenu}>
									Adventures
								</Link>
								{canCreateAdventure(user) && (
									<Link to="/adventures/create" onClick={closeMenu}>
										Create
									</Link>
								)}
								{canCreateAdventure(user) && (
					...
					{canPlay(user) && (
						<Link className={styles.navLink} to="/equipment">
							Equipment
						</Link>
					)}
					{canCreateAdventure(user) && (
						<Link className={styles.navLink} to="/soundboards">
							Sound
						</Link>
					)}
					{canManageUsers(user) && (
						<div className={styles.menu}>
							...
							{openMenu === "admin" && (
								<div className={styles.menuPanel}>
									...
									<Link to="/admin/audit" onClick={closeMenu}>
										Audit
									</Link>
									<Link to="/admin/ai" onClick={closeMenu}>
										AI lab
									</Link>
									<Link to="/admin/ai/prompts" onClick={closeMenu}>
										Prompts
									</Link>
									<Link to="/admin/ai/logs" onClick={closeMenu}>
										AI log
									</Link>
								</div>
							)}
					...
					{canManageUsers(user) && (
						<div className={styles.menu}>
							...
							{openMenu === "books" && (
								<div className={styles.menuPanel}>
									<Link to="/admin/content/books/create" onClick={closeMenu}>
										Upload
									</Link>
									<Link to="/admin/content/books/edit" onClick={closeMenu}>
										Edit
									</Link>
								</div>
							)}
