	...
	return (
		<Routes>
			...
			<Route
				path="/characters"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.PLAYER_ONLY]}>
						<AppLayout>
							<CharactersPage />
						</AppLayout>
					</ProtectedRoute>
			...
			<Route
				...
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.PLAYER_ONLY]}>
						<AppLayout>
							<CharacterDetailPage mode="edit" />
						</AppLayout>
					</ProtectedRoute>
				}
			/>
			<Route
				path="/characters/:characterId/profile"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.PLAYER_ONLY]}>
						<AppLayout>
			...
			/>
			<Route
				path="/characters/:characterId/beastforms"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.PLAYER_ONLY]}>
						<AppLayout>
							<DruidBeastFormsPage />
			...
			/>
			<Route
				path="/admin/content/books/create"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.ADMIN]}>
						<AppLayout>
							<BookImportPage />
			...
			<Route
				...
				element={<Navigate to="/admin/content/books/create" replace />}
			/>
			<Route
				path="/admin/content/books/edit"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.ADMIN]}>
						<AppLayout>
							<BookContentEditorPage />
						</AppLayout>
					</ProtectedRoute>
				}
			/>
			<Route
				path="/admin/content/books/beast-features"
				element={
					<ProtectedRoute allowedAccessLevels={[ACCESS_LEVELS.ADMIN]}>
						<AppLayout>
							<BeastFeatureEditorPage />
						</AppLayout>
					</ProtectedRoute>
				}
			/>
